...
public class ConfigReader {
    ...
    public static String getFileTargetDir() {
        return configParameters.fileTargetDir;
    }

    public static String getFileSourceDir() {
        return configParameters.fileSourceDir;
    }
    ...
    public static int getFieldLength() {
        return configParameters.fieldLength;
    }

    public static int getFileNameLength() {
        return configParameters.fileNameLength;
    }

    public static int getFileDescriptionLength() {
        return configParameters.fileDescriptionLength;
    }
    ...
    public static int getNumberOfQueriesIfError() {
        return configParameters.numberOfQueriesIfError;
    }
